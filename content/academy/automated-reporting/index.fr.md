...
price_section:
  ...
  includes:
    - "une rencontre d’adéquation et de cadrage du workflow"
    ...
    - "1 rencontre individuelle de revue de workflow"
...
fit_section:
  ...
  not_points:
    - "débutant.e.s en R"
    - "acheteurs qui cherchent un tutoriel Quarto ou de design de rapport à faible accompagnement"
    - "projets qui relèvent plutôt d’un développement Systems personnalisé plus large"
    - "participant.e.s sans cas d’usage réel ou sans temps pour continuer à bâtir après l’atelier"
